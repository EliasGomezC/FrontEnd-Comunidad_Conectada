...
export default function DetalleCuotaPage(){
  ...
  return <div className="flex min-h-screen bg-[#e5eaee]"><Sidebar activeItem="Pagos"/><main className="flex-1 p-8">
