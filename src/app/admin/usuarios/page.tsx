...
export default function UsuariosPage() {
  ...
  return <div className="flex min-h-screen bg-[#e5ebf1]"><Sidebar activeItem="Usuarios" /><main className="min-w-0 flex-1 p-5 pt-20 text-[#073f60] sm:p-6 sm:pt-24 md:p-10 md:pt-10">
