...
export default function ReservacionesPage() {
  ...
  return <div className="flex min-h-screen bg-[#dfe5eb]"><Sidebar activeItem="Reservaciones" /><main className="min-w-0 flex-1 p-4 pt-20 sm:p-6 sm:pt-24 md:p-[30px] md:pt-6">
