...
export default function PagosHabitantePage(){
 ...
 return <div className="flex min-h-screen bg-[#e5eaee]"><Sidebar activeItem="Pagos"/><main className="flex-1 p-8"><h1 className="text-5xl font-bold text-[#0a496a]">Control de Pagos</h1><p className="mb-7 text-xl text-[#295c7f]">Tus cuotas y comprobantes de pago</p>
