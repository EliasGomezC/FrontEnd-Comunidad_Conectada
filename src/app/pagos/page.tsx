...
export default function PagosHabitantePage(){
 ...
 return <div className="flex min-h-screen bg-[#e5eaee]"><Sidebar activeItem="Pagos"/><main className="min-w-0 flex-1 p-4 pt-20 sm:p-6 sm:pt-24 lg:pt-6"><h1 className="text-3xl font-bold text-[#0a496a] sm:text-4xl md:text-5xl">Control de Pagos</h1><p className="mb-7 text-lg text-[#295c7f]">Tus cuotas y comprobantes de pago</p>
