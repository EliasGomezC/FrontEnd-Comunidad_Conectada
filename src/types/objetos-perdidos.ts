...
export interface GaleriaItem { id:string; url:string }
...
export interface ObjetoPerdido {
  ...
  imagen:string|null; galeria?:GaleriaItem[]; ubicacion:string; fecha_evento:string|null; informacion_adicional:string;
...
export interface CrearObjeto { privada:string; nombre:string; descripcion:string; tipo:TipoObjeto; ubicacion:string; fecha_evento:string; informacion_adicional?:string; detalles_privados?:string; preguntas?:string[]; imagen?:File|null; galeria_archivos?:File[]; galeria_eliminar?:string[] }
