...
export interface ReporteGaleriaItem { id:string; url:string; }
export interface IncidenteReporte {
  ...
  ubicacion:string; evidencia:string; galeria?:ReporteGaleriaItem[]; usuario:string; habitante:PersonaResumen; privada:string;
...
export interface Reporte {
  ...
  prioridad:PrioridadReporte; estado:EstadoReporte; fecha_suceso:string; evidencia:string; galeria?:ReporteGaleriaItem[];
  created_at:string; updated_at:string;
}
export interface CrearIncidenteReporteRequest { privada:string; titulo:string; descripcion:string; tipo_categoria:string; prioridad:PrioridadReporte; fecha_incidente:string; ubicacion:string; evidencia?:File|null; galeria_archivos?:File[]; galeria_eliminar?:string[]; }
export interface CrearReporteRequest { incidente:string; titulo:string; descripcion:string; evidencia?:File|null; galeria_archivos?:File[]; galeria_eliminar?:string[]; }
